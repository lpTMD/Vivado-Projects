...
HD_PWD='E:/Vivado Projects/ECE 3300L/Lab11/Lab11.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log L11.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source L11.tcl
