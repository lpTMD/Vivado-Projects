...
HD_PWD='E:/Vivado Projects/ECE 3300L/Lab11/Lab11.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log L11.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source L11.tcl -notrace
