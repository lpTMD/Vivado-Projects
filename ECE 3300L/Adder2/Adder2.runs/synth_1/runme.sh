...
HD_PWD='E:/Vivado Projects/ECE 3300L/Adder2/Adder2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Cadder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Cadder.tcl
