...
HD_PWD='E:/Vivado Projects/ECE 3300L/Lab 9/Lab 9.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log L9.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source L9.tcl
