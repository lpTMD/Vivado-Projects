...
HD_PWD='E:/Vivado Projects/ECE 3300L/Lab 9/Lab 9.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log L9.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source L9.tcl -notrace
