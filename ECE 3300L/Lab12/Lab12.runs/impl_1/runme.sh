...
HD_PWD='E:/Vivado Projects/ECE 3300L/Lab12/Lab12.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log L12.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source L12.tcl -notrace
