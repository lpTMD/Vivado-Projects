...
HD_PWD='E:/Vivado Projects/ECE 3300L/Lab12/Lab12.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log L12.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source L12.tcl
