...
HD_PWD='E:/Vivado Projects/ECE 3300L/Final/Final.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lasers.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lasers.tcl -notrace
