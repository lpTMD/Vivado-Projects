...
HD_PWD='E:/Vivado Projects/ECE 3300L/Final/Final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lasers.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lasers.tcl
