...
set rc [catch {
  ...
  set_property webtalk.parent_dir {E:/Vivado Projects/ECE 3300L/Lab_8/Lab_8.cache/wt} [current_project]
  set_property parent.project_path {E:/Vivado Projects/ECE 3300L/Lab_8/Lab_8.xpr} [current_project]
  set_property ip_output_repo {{E:/Vivado Projects/ECE 3300L/Lab_8/Lab_8.cache/ip}} [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  add_files -quiet {{E:/Vivado Projects/ECE 3300L/Lab_8/Lab_8.runs/synth_1/SongPlayer.dcp}}
  read_xdc {{E:/Vivado Projects/ECE 3300L/Lab_8/Lab_8.srcs/constrs_1/new/bb.xdc}}
...
set rc [catch {
  ...
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -file SongPlayer_timing_summary_routed.rpt -pb SongPlayer_timing_summary_routed.pb -rpx SongPlayer_timing_summary_routed.rpx -warn_on_violation "
...
set rc [catch {
  ...
  catch { write_mem_info -force SongPlayer.mmi }
