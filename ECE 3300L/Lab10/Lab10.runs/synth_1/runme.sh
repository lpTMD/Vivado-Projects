...
HD_PWD='E:/Vivado Projects/ECE 3300L/Lab10/Lab10.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log L10.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source L10.tcl
