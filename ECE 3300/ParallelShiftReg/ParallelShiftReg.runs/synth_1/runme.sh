...
HD_PWD='E:/Vivado Projects/ECE 3300/ParallelShiftReg/ParallelShiftReg.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PASR.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PASR.tcl
