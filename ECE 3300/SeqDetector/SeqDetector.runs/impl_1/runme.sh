...
HD_PWD='E:/Vivado Projects/ECE 3300/SeqDetector/SeqDetector.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Ba.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Ba.tcl -notrace
