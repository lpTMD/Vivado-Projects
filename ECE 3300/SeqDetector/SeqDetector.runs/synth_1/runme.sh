...
HD_PWD='E:/Vivado Projects/ECE 3300/SeqDetector/SeqDetector.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Ba.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Ba.tcl
