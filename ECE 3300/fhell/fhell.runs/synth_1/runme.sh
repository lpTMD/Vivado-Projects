...
HD_PWD='E:/Vivado Projects/ECE 3300/fhell/fhell.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ffff.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ffff.tcl
